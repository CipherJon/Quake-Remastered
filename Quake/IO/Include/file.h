...
{
public:
	// Implement PakFile specific methods here
protected:
	// Add PakFile specific members here
};
...
{
public:
	// Implement SearchPath specific methods here
protected:
	// Add SearchPath specific members here
};